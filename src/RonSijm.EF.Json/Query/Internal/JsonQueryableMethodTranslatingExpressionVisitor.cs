...
/// <summary>
/// Expression visitor for translating queryable methods for JSON provider.
/// This class intentionally returns null for most Translate* methods because
/// the JSON provider does not support server-side LINQ operations.
/// All LINQ operations are performed client-side after ToList().
/// </summary>
[ExcludeFromCodeCoverage]
public class JsonQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    /// <summary>
    /// Creates a new instance of <see cref="JsonQueryableMethodTranslatingExpressionVisitor"/>.
    /// </summary>
    public JsonQueryableMethodTranslatingExpressionVisitor(
    ...
    /// </summary>
    protected JsonQueryableMethodTranslatingExpressionVisitor(
        JsonQueryableMethodTranslatingExpressionVisitor parentVisitor)
    ...
    protected override QueryableMethodTranslatingExpressionVisitor CreateSubqueryVisitor()
        => new JsonQueryableMethodTranslatingExpressionVisitor(this);

    /// <inheritdoc />
    protected override ShapedQueryExpression CreateShapedQueryExpression(IEntityType entityType)
    {
        var queryExpression = new JsonQueryExpression(entityType);
