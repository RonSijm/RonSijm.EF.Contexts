...
/// <summary>
/// Expression visitor for compiling shaped queries for the JSON provider.
/// </summary>
public class JsonShapedQueryCompilingExpressionVisitor : ShapedQueryCompilingExpressionVisitor
{
    ...
    /// <summary>
    /// Creates a new instance of <see cref="JsonShapedQueryCompilingExpressionVisitor"/>.
    /// </summary>
    public JsonShapedQueryCompilingExpressionVisitor(
    ...
    protected override Expression VisitShapedQuery(ShapedQueryExpression shapedQueryExpression)
    {
        ...
        if (queryExpression is JsonQueryExpression jsonQueryExpression)
        {
            var entityType = jsonQueryExpression.EntityType;

            // Create the enumerable expression that reads from the JSON store
    ...
    private Expression CreateEnumerableExpression(IEntityType entityType, Expression shaperExpression)
    {
        ...
        var queryMethod = typeof(JsonShapedQueryCompilingExpressionVisitor)
    ...
    private static IEnumerable<TEntity> QueryEntities<TEntity>(QueryContext queryContext, IEntityType entityType)
        where TEntity : class
    {
        var database = queryContext.Context.GetService<IJsonDatabase>();
