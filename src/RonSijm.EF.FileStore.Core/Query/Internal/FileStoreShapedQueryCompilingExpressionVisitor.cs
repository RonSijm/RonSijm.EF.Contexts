...
/// <summary>
/// Expression visitor for compiling shaped queries for file-based providers.
/// </summary>
public class FileStoreShapedQueryCompilingExpressionVisitor : ShapedQueryCompilingExpressionVisitor
{
    ...
    /// <summary>
    /// Creates a new instance of <see cref="FileStoreShapedQueryCompilingExpressionVisitor"/>.
    /// </summary>
    ...
    protected override Expression VisitShapedQuery(ShapedQueryExpression shapedQueryExpression)
    {
        ...
        if (queryExpression is FileStoreQueryExpression fileStoreQueryExpression)
        {
            var entityType = fileStoreQueryExpression.EntityType;
    ...
    {
        var queryMethod = typeof(FileStoreShapedQueryCompilingExpressionVisitor)
    ...
    private static IEnumerable<TEntity> QueryEntities<TEntity>(QueryContext queryContext, IEntityType entityType)
        where TEntity : class
    {
        var database = queryContext.Context.GetService<IFileDatabase>();
