...
/// <summary>
/// Expression visitor for translating queryable methods for the CSV provider.
/// This class intentionally returns null for most Translate* methods because
/// the CSV provider does not support server-side LINQ operations.
/// All LINQ operations are performed client-side after ToList().
/// </summary>
[ExcludeFromCodeCoverage]
public class CsvQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    /// <summary>
    /// Creates a new instance of <see cref="CsvQueryableMethodTranslatingExpressionVisitor"/>.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new instance for subquery processing.
    /// </summary>
    protected CsvQueryableMethodTranslatingExpressionVisitor(
    ...
    {
        var queryExpression = new CsvQueryExpression(entityType);
